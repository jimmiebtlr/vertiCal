...
Template["vertiCalDefaultUpArrow"] = new Template("Template.vertiCalDefaultUpArrow", (function() {         // 25
  var view = this;                                                                                         // 26
  return HTML.Raw('<div class="vertiCalControls">\n    <i class="fa fa-sort-asc fa-fw"></i>\n  </div>');   // 27
}));                                                                                                       // 28
                                                                                                           // 29
...
Template["vertiCalDefaultDateContent"] = new Template("Template.vertiCalDefaultDateContent", (function() { // 31
  ...
  return HTML.DIV({                                                                                        // 33
    "class": function() {                                                                                  // 34
      return [ "vertiCalElement ", Spacebars.mustache(view.lookup("active")) ];                            // 35
    }                                                                                                      // 36
...
Template.vertiCal.dates = function(){                                                                      // 7
  var num = this.number ? this.number : 7;                                                                 // 8
  var indexs = [];                                                                                         // 9
  for( i = 0; i < num; i++ ){                                                                              // 10
    indexs.push(i);                                                                                        // 11
  }                                                                                                        // 12
